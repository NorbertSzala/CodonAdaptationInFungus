...
#count_codons <- scan('/home/norbert/IBB/skrypty/count_codons.txt') #import file
count_codons <- scan('/home/norbert_s/gtAI/count_codons.txt') #import file

codons_rav <- get.ws(tRNA = count_codons, sking = 0) #sking = 0 for eukaryota. rav meand relative adaptiveness values for each tRNA
...
codons_tai <- get.tai(codons_frequencies, codons_rav) #calculating codon_tai
